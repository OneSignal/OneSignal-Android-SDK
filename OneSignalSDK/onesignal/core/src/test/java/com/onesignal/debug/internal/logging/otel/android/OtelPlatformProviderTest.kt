...
class OtelPlatformProviderTest : FunSpec({
    ...
    // Default no-op FeatureManager; tests that care override it via withFeatureManager(...).
    fun emptyFeatureManager(): IFeatureManager =
    ...
    test("enabledFeatureFlags reads fresh from the injected FeatureManager on each access") {
        ...
        provider.enabledFeatureFlags shouldBe listOf("sdk_background_threading", "sdk_other_flag")
    }
