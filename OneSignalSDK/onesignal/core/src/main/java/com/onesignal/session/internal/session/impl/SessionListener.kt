...
internal class SessionListener(
    ...
    override fun onSessionStarted() {
        ...
        _operationRepo.enqueue(TrackSessionStartOperation(_configModelStore.model.appId, _identityModelStore.model.onesignalId, _identityModelStore.model.externalId), true)
    }
    ...
    override fun onSessionEnded(duration: Long) {
        ...
        _operationRepo.enqueue(
            TrackSessionEndOperation(_configModelStore.model.appId, _identityModelStore.model.onesignalId, _identityModelStore.model.externalId, durationInSeconds),
        )
