...
internal class LoginUserOperationExecutor(
    ...
    private suspend fun loginUser(
        ...
        // Handle a bad state that can happen in User Model 5.1.27 or earlier versions that ID translations
        // are lost if app is force-closed within the PostCreateDelay.
