...
class CustomEvent() : Model() {
    ...
    var properties: Map<String, Any>?
        get() = getOptAnyProperty(::properties.name) as Map<String, Any>?
        private set(value) {
            value?.let { setAnyProperty(::properties.name, it) }
        }

    constructor(name: String, properties: Map<String, Any>?) : this() {
        this.name = name
