 ...
 */
internal class InfluenceConfigModel(parentModel: Model, parentProperty: String) : Model(parentModel, parentProperty) {
    /**
 ...
 */
internal class FCMConfigModel(parentModel: Model, parentProperty: String) : Model(parentModel, parentProperty) {
    /**
     * The FCM project ID.
     */
