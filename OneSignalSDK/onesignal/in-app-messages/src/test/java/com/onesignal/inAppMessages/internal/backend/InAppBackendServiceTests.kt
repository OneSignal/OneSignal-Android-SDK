...
class InAppBackendServiceTests :
    FunSpec({
        ...
        test("listInAppMessages with no messages returns zero-lengthed array") {
            ...
            // When
            val response = inAppBackendService.listInAppMessages("appId", "onesignal_id", "user123", "subscriptionId", RywData("123", 500L), mockSessionDurationProvider)
        ...
        test(
            ...
            // When
            val response = inAppBackendService.listInAppMessages("appId", "onesignal_id", "user123", "subscriptionId", RywData("1234", 500L), mockSessionDurationProvider)
            ...
            coVerify(exactly = 1) {
                mockHttpClient.get(
                    "apps/appId/users/by/onesignal_id/user123/subscriptions/subscriptionId/iams",
                    match {
