...
class InAppBackendServiceTests :
    FunSpec({
        ...
        test("listInAppMessages with no messages returns zero-lengthed array") {
            ...
            // When
            val response = inAppBackendService.listInAppMessages("appId", "subscriptionId", 123L, 456L)
        ...
        test(
            ...
            // When
            val response = inAppBackendService.listInAppMessages("appId", "subscriptionId", 1234L, 1)
            ...
            headersValues.offset = 1234L

            coVerify(exactly = 1) {
                mockHttpClient.get(
                    "apps/appId/subscriptions/subscriptionId/iams",
                    match {
                        it.offset == 1234L && it.secondsSinceAppOpen == 1L && it.retryCount == null
                    },
                )
            }
            ...
            coVerify(exactly = 3) {
                mockHttpClient.get(
                    "apps/appId/subscriptions/subscriptionId/iams",
                    match {
                        it.offset == 1234L && it.retryCount != null
                    },
                )
            }
            ...
            coVerify(exactly = 1) {
                mockHttpClient.get(
                    "apps/appId/subscriptions/subscriptionId/iams",
                    match {
                        it.offset == null && it.retryCount == null
                    },
                )
            }
        }
